---
title: "Poultry Model for Turkey specific DR"
...
serotype_probabilities_2021 <- readxl::read_xlsx("Serotype_Probabilities.xlsx", sheet = "HACCP 2016-2021 (all)") # HACCP baseline 2016-2021 or new 2023-2024 
serotype_probabilities_2024 <- readxl::read_xlsx("Serotype_Probabilities.xlsx", sheet = "HACCP 2023-2024 (all)")
...
get_table_values <- function(full_results_table) {
  specific_table <- data.frame(
    scenario = c(rep(c("Over the level threshold", "Under the level threshold", "Inclusion list&over the level threshold", "Inclusion list|over the level threshold", "Exclusion&over the level threshold", "No Exclusion&over the level threshold"), each=3)),
    threshold = rep(
      c(
...
teunis_dose_response <- function(sample_size, sample_serotype, tuenis_submodel_parameters, serotype_equivalents, dose=1, debug=FALSE) {
  ...
  if (length(equivalent_serotype_row) > 0) {
    ...
    if (sample_serotype %in% c("Baildon", "Berta", "Blockley", "Bovismorbificans", "Chailey", "Dublin", "Hadar", "Hillingdon", "I 1,4,[5],12:b:-", "Litchfield", "Manhattan", "Newport", "Saintpaul", "Stanley")){
        equivalent_serotype <- c("Enteritidis", "Typhimurium")[sample(2,1)]
      }else if(sample_serotype %in% c("Adelaide","Agbeni","Agona","Alachua","Albany","Anatum","Bareilly","Braenderup","Brandenburg","Calabar","Carrau","Cerro","Chester","Concord","Cubana","Duisburg","Eastbourne","Gaminara","Gateshead","Give","Goldcoast","Hartford","Heidelberg","Hvittingfoss","Idikan","Infantis","Javiana","Johannesburg","Vaccined","Kiambu","Koessen","Leiden","Livingstone","Lomalinda","Lubbock","Mbandaka","Meleagridis","Miami","Mississippi","Montevideo","Muenster","Norwich","Ohio","Okatie","Oranienburg","Panama","Poona","Potsdam","Reading","Rissen","Rubislaw","Sandiego","Schwarzengrund","Senftenberg","Telelkebir","Thompson","Uganda","Urbana","Vinohrady","Virchow","Weltevreden")){
        equivalent_serotype <- c("Anatum")
          }else{
            equivalent_serotype <- c("Anatum", "Enteritidis", "Typhimurium")[sample(3,1)]
          }
      tdr_parameter_row <- which(tuenis_submodel_parameters$serotype==equivalent_serotype)
...
poultry_model <- function(i, total_iterations, simulation_batch, model_mode, serotype_probabilities, serotype_equivalents, salmonella_mean, salmonella_st_dev, attenuation_input, inclusion_list_input, exclusion_list_input, scaling_factor, product_consumed_per_individual_per_day_mean, product_consumed_per_individual_per_day_st_dev, teunis_dose_response, tuenis_submodel_parameters, pr_ill_from_dose, use_attenuation=TRUE, use_scaling_factor=TRUE) {
  ...
  # Exclusion List
  is_serotype_on_exclusion_list <- any(grepl(serotype_in_serving, serotype_exclusion_list)) # Is serotype on Exclusion List(=Typhimurium - Possible Vaccine Strain)?
  ...
  # T1orInclusion List+Noncompliant
  ...
  # T2orInclusion List+Noncompliant
  ...
  # T3orInclusion List+Noncompliant
...
```{r Variable Attenuation & Scaled Run for comminuted turkey, HACCP baseline (2016-2021) Bayesian fitting #inclusion list 1}
# Parameter setup ----
...
salmonella_mean <- -4.857 #FSIS HACCP Data 2016-2021 using Bayesian fitting
salmonella_st_dev <- 2.052 #FSIS HACCP Data 2016-2021 using Bayesian fitting 
...
m3_variable_attenuation_scaled <- poultry_model_clustered(
  ...
  inclusion_list_input=c("Typhimurium", "Hadar", "Muenchen"),
  # Change the inclusion list based on different scenarios;
  # inclusion_1: c("Typhimurium", "Hadar", "Muenchen"); 
  # inclusion_2_Cluster1 for 2016-2021:c("Typhimurium", "Hadar", "Muenchen","I 4,[5],12:i:-","Berta","Newport", "Saintpaul", "Enteritidis", "Litchfield", "Manhattan");
  exclusion_list_input=c("Kentucky"), 
  #c("Vaccined") of want to exclude "Typhimurium - Possible Vaccine Strain") ;
  #c("Adelaide","Agbeni","Agona","Alachua","Albany","Anatum","Bareilly","Braenderup","Brandenburg","Calabar","Carrau","Cerro","Chester","Concord","Cubana","Duisburg","Eastbourne","Gaminara","Gateshead","Give","Goldcoast","Hartford","Heidelberg","Hvittingfoss","Idikan","Infantis","Javiana","Johannesburg","Vaccined","Kiambu","Koessen","Leiden","Livingstone","Lomalinda","Lubbock","Mbandaka","Meleagridis","Miami","Mississippi","Montevideo","Muenster","Norwich","Ohio","Okatie","Oranienburg","Panama","Poona","Potsdam","Reading","Rissen","Rubislaw","Sandiego","Schwarzengrund","Senftenberg","Telelkebir","Thompson","Uganda","Urbana","Vinohrady","Virchow","Weltevreden") if want to exclude all lower-viruelence serotypes;
  scaling_factor = 0.002, 
  # 0.00023 -> pill=2.041748e-06
  # 0.00024 -> pill=2.093632e-06
  # 0.00025 -> pill=2.145559e-06
  ...
  comment = "m3_variable_2021_list1_Baye_kentucky" # User/Scenario comment; HIGHLY RECOMMENDED TO EDIT AS APPROPRIATE
)
m3_variable_attenuation_scaled_specifics <- get_table_values(m3_variable_attenuation_scaled) # Extracts specific data needed for Li et al., 2025 paper
mean(m3_variable_attenuation_scaled$tdr_mean_pr_ill)# Average probability of illness; adjust the SF to match this number to around 2E-6
```

```{r Variable Attenuation & Scaled Run for comminuted turkey, HACCP baseline (2016-2021) Bayesian fitting #inclusion list 2}
# Parameter setup ----
# NOTE: You can put these number straight into poultry_model_clustered() instead of defining them here, but this method lets you cite data sources more cleanly
salmonella_mean <- -4.857 #FSIS HACCP Data 2016-2021 using Bayesian fitting
salmonella_st_dev <- 2.052 #FSIS HACCP Data 2016-2021 using Bayesian fitting
...
m3_variable_attenuation_scaled <- poultry_model_clustered(
  ...
  salmonella_st_dev = salmonella_st_dev, # Log10 Salmonella dose standard deviation; CAN BE CHANGED WITH A DIFFERENT VALUE
  attenuation_input = c(-5, 1.91), # FSIS Variable attenuation, Quantitative Risk Assessment for Salmonella in Raw Chicken and Raw Chicken Products, page 42 
  inclusion_list_input=c("Typhimurium", "Hadar", "Muenchen","I 4,[5],12:i:-","Berta","Newport", "Saintpaul", "Enteritidis", "Litchfield", "Manhattan"),
  # Change the inclusion list based on different scenarios;
  # inclusion_1: c("Typhimurium", "Hadar", "Muenchen"); 
  # inclusion_2_Cluster1 for 2016-2021:c("Typhimurium", "Hadar", "Muenchen","I 4,[5],12:i:-","Berta","Newport", "Saintpaul", "Enteritidis", "Litchfield", "Manhattan");
  exclusion_list_input=c("Kentucky"), 
  ...
  use_attenuation = TRUE, # Use attenuation?
  use_scaling_factor = TRUE, # Use scaling factor?; DO NOT CHANGE
  comment = "m3_variable_2021_list2_Baye_kentucky" # User/Scenario comment; HIGHLY RECOMMENDED TO EDIT AS APPROPRIATE
)
m3_variable_attenuation_scaled_specifics <- get_table_values(m3_variable_attenuation_scaled) # Extracts specific data needed for Li et al., 2025 paper
mean(m3_variable_attenuation_scaled$tdr_mean_pr_ill)# Average probability of illness; adjust the SF to match this number to around 2E-6
```

```{r Variable Attenuation & Scaled Run for comminuted turkey, HACCP baseline (2016-2021) FSIS Salmonella level #inclusion list 1}
# Parameter setup ----
# NOTE: You can put these number straight into poultry_model_clustered() instead of defining them here, but this method lets you cite data sources more cleanly
salmonella_mean <- -4.857 #FSIS HACCP Data 2016-2021
salmonella_st_dev <- 2.333 #FSIS HACCP Data 2016-2021
...
m3_variable_attenuation_scaled <- poultry_model_clustered(
  ...
  use_attenuation = TRUE, # Use attenuation?
  use_scaling_factor = TRUE, # Use scaling factor?; DO NOT CHANGE
  comment = "m3_variable_2021_list1_FSISfit_kentucky" # User/Scenario comment; HIGHLY RECOMMENDED TO EDIT AS APPROPRIATE
)
m3_variable_attenuation_scaled_specifics <- get_table_values(m3_variable_attenuation_scaled) # Extracts specific data needed for Li et al., 2025 paper
mean(m3_variable_attenuation_scaled$tdr_mean_pr_ill)# Average probability of illness; adjust the SF to match this number to around 2E-6
```

```{r Variable Attenuation & Scaled Run for comminuted turkey, HACCP baseline (2016-2021) FSIS Salmonella level #inclusion list 2}
# Parameter setup ----
# NOTE: You can put these number straight into poultry_model_clustered() instead of defining them here, but this method lets you cite data sources more cleanly
salmonella_mean <- -4.857 #FSIS HACCP Data 2016-2021
salmonella_st_dev <- 2.333 #FSIS HACCP Data 2016-2021
...
m3_variable_attenuation_scaled <- poultry_model_clustered(
  ...
  use_attenuation = TRUE, # Use attenuation?
  use_scaling_factor = TRUE, # Use scaling factor?; DO NOT CHANGE
  comment = "m3_variable_2021_list2_FSISfit_kentucky" # User/Scenario comment; HIGHLY RECOMMENDED TO EDIT AS APPROPRIATE
)
m3_variable_attenuation_scaled_specifics <- get_table_values(m3_variable_attenuation_scaled) # Extracts specific data needed for Li et al., 2025 paper
mean(m3_variable_attenuation_scaled$tdr_mean_pr_ill)# Average probability of illness; adjust the SF to match this number to around 2E-6
```

```{r Variable Attenuation & Scaled Run for comminuted turkey, HACCP new (2023-2024) #inclusion list 1}
# Parameter setup ----
# NOTE: You can put these number straight into poultry_model_clustered() instead of defining them here, but this method lets you cite data sources more cleanly
...
m3_variable_attenuation_scaled <- poultry_model_clustered(
  ...
  salmonella_st_dev = salmonella_st_dev, # Log10 Salmonella dose standard deviation; CAN BE CHANGED WITH A DIFFERENT VALUE
  attenuation_input = c(-5, 1.91), # FSIS Variable attenuation, Quantitative Risk Assessment for Salmonella in Raw Chicken and Raw Chicken Products, page 42
  inclusion_list_input= c("Typhimurium", "Hadar", "I 4,[5],12:i:-"), #c("Typhimurium", "Hadar", "Muenchen"),
  # Change the inclusion list based on different scenarios;
  # inclusion_1: c("Typhimurium", "Hadar", "Muenchen"); 
  # inclusion_2_Cluster1 for 2023-2024: c("Typhimurium", "Hadar", "Muenchen","I 4,[5],12:i:-", "Enteritidis", "Newport")
  exclusion_list_input=c("Kentucky"), 
  #c("Vaccined") of want to exclude "Typhimurium - Possible Vaccine Strain") ;
  #c("Adelaide","Agbeni","Agona","Alachua","Albany","Anatum","Bareilly","Braenderup","Brandenburg","Calabar","Carrau","Cerro","Chester","Concord","Cubana","Duisburg","Eastbourne","Gaminara","Gateshead","Give","Goldcoast","Hartford","Heidelberg","Hvittingfoss","Idikan","Infantis","Javiana","Johannesburg","Vaccined","Kiambu","Koessen","Leiden","Livingstone","Lomalinda","Lubbock","Mbandaka","Meleagridis","Miami","Mississippi","Montevideo","Muenster","Norwich","Ohio","Okatie","Oranienburg","Panama","Poona","Potsdam","Reading","Rissen","Rubislaw","Sandiego","Schwarzengrund","Senftenberg","Telelkebir","Thompson","Uganda","Urbana","Vinohrady","Virchow","Weltevreden") if want to exclude all lower-viruelence serotypes;
  scaling_factor = 0.00025,
  # 0.00025 -> 2.297141e-06 (SPHS), 
  # 0.00025 -> 2.232401e-06 (cluster1),
  product_consumed_per_individual_per_day_mean = product_consumed_per_individual_per_day_mean, # Log10 Product consumed mean; CAN BE CHANGED IF YOU HAVE NEW DATA, OTHERWISE USE CDC 2016, Lambertini  et al. (2019)
  product_consumed_per_individual_per_day_st_dev = product_consumed_per_individual_per_day_st_dev, # Log10 Product consumed standard deviation; CAN BE CHANGED IF YOU HAVE NEW DATA, OTHERWISE USE CDC 2016, Lambertini  et al. (2019)
  ...
  use_attenuation = TRUE, # Use attenuation?
  use_scaling_factor = TRUE, # Use scaling factor?; DO NOT CHANGE
  comment = "m3_variable_2024_list1_kentucky" # User/Scenario comment; HIGHLY RECOMMENDED TO EDIT AS APPROPRIATE
)
m3_variable_attenuation_scaled_specifics <- get_table_values(m3_variable_attenuation_scaled) # Extracts specific data needed for Li et al., 2025 paper
mean(m3_variable_attenuation_scaled$tdr_mean_pr_ill)# Average probability of illness; adjust the SF to match this number to around 2E-6
```

```{r Variable Attenuation & Scaled Run for comminuted turkey, HACCP new (2023-2024) #inclusion list 2}
# Parameter setup ----
# NOTE: You can put these number straight into poultry_model_clustered() instead of defining them here, but this method lets you cite data sources more cleanly
salmonella_mean <- -4.607818  #FSIS HACCP Data 2023-2024
salmonella_st_dev <- 2.206763 #FSIS HACCP Data 2023-2024
...
m3_variable_attenuation_scaled <- poultry_model_clustered(
  ...
  salmonella_st_dev = salmonella_st_dev, # Log10 Salmonella dose standard deviation; CAN BE CHANGED WITH A DIFFERENT VALUE
  attenuation_input = c(-5, 1.91), # FSIS Variable attenuation, Quantitative Risk Assessment for Salmonella in Raw Chicken and Raw Chicken Products, page 42
  inclusion_list_input=c("Typhimurium", "Hadar", "Muenchen","I 4,[5],12:i:-", "Enteritidis", "Newport"),
  # Change the inclusion list based on different scenarios;
  # inclusion_1: c("Typhimurium", "Hadar", "Muenchen"); 
  # inclusion_2_Cluster1 for 2023-2024: c("Typhimurium", "Hadar", "Muenchen","I 4,[5],12:i:-", "Enteritidis", "Newport")
  exclusion_list_input=c("Kentucky"),
  ...
  use_attenuation = TRUE, # Use attenuation?
  use_scaling_factor = TRUE, # Use scaling factor?; DO NOT CHANGE
  comment = "m3_variable_2024_list2_Kentucky" # User/Scenario comment; HIGHLY RECOMMENDED TO EDIT AS APPROPRIATE
)
m3_variable_attenuation_scaled_specifics <- get_table_values(m3_variable_attenuation_scaled) # Extracts specific data needed for Li et al., 2025 paper
mean(m3_variable_attenuation_scaled$tdr_mean_pr_ill)# Average probability of illness; adjust the SF to match this number to around 2E-6
```
...
m3_variable_attenuation_scaled
```
